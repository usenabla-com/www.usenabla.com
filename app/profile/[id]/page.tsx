    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Testing Section - Only for own profile */}
          {isOwnProfile && (
            <Card className="shadow-sm mt-6">
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">Testing & Development</h3>
                    <p className="text-sm text-gray-600">Test push notifications and content features</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                      Test different types of push notifications to ensure they're working correctly.
                    </p>
                  ...
                  {/* Content Curation Testing */}
                  <div className="space-y-4">
                    <div className="flex items-center gap-2 mb-3">
                      <Sparkles className="h-5 w-5 text-green-600" />
                      <h4 className="font-semibold text-gray-900">Content Curation</h4>
                    </div>
                    <p className="text-sm text-gray-600 mb-4">
                      Manually trigger content curation to refresh your personalized feed.
                    </p>
                    <Button
                      onClick={triggerCuration}
                      disabled={triggering}
                    ...
                    >
                      ...
                      {triggering ? 'Curating New Content...' : 'Trigger Content Curation'}
                    </Button>
                    {feedItems.length > 0 && (
                      <p className="text-xs text-gray-500 mt-2">
                        Last updated: {feedItems[0]?.created_at ? new Date(feedItems[0].created_at).toLocaleString() : 'Unknown'}
                      </p>
                    )}
                  </div>
                </div>
                ...
                <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h5 className="font-medium text-yellow-900 mb-1">Development Mode</h5>
                      <p className="text-sm text-yellow-800">
                        This testing section is only visible on your own profile. Push notifications use server-side processing 
                        to ensure security and compliance with the web-push protocol.
                      </p>
                    </div>
                  </div>
                </div>
