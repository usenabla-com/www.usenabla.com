    ...
    <section className="relative overflow-hidden py-24 md:py-32 bg-background font-sans">
      ...
      <div className="container relative z-10 px-4 md:px-8 max-w-7xl mx-auto">
        <div className="flex flex-col items-center text-center space-y-6 max-w-4xl mx-auto">
          ...
          {/* Subheadline */}
          <p className="text-muted-foreground text-lg md:text-xl leading-relaxed tracking-tight max-w-3xl">
            {subheadline}
          </p>
          ...
          <div
            ...
            className="mx-auto mt-8 max-w-md w-full bg-gradient-to-r from-primary to-primary/90 border border-primary/20 backdrop-blur-md rounded-2xl p-6 shadow-lg cursor-pointer group transition-all duration-300 hover:scale-[1.02] hover:shadow-xl"
          >
