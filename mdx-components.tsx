  ...
  return {
    ...
    h1: ({ children }) => {
      ...
      const id = text
        ...
        .replace(/\s+/g, '-')
      return (
        <h1 id={id || undefined} className="scroll-mt-24 text-4xl font-bold tracking-tight mb-6 border-b pb-3 font-sans">
          {children}
        </h1>
      )
    },
    h2: ({ children }) => {
      ...
      const id = text
        ...
        .replace(/\s+/g, '-')
      return (
        <h2 id={id || undefined} className="scroll-mt-24 text-3xl font-semibold tracking-tight mt-8 mb-4 border-b pb-2 font-sans">
          {children}
        </h2>
      )
    },
    h3: ({ children }) => {
      ...
      const id = text
        ...
        .replace(/\s+/g, '-')
      return (
        <h3 id={id || undefined} className="scroll-mt-24 text-2xl font-semibold tracking-tight mt-6 mb-3 font-sans">
          {children}
        </h3>
      )
    },
